package main.java.com.bad_java.homework.hyperskill.CoffeeMachine._05_06;
...
public class CoffeeMachineService {
  ...
  public void buyCoffeeByType (String coffeeType) {
    switch (coffeeType) {
      case "1": { // espresso
  ...
  private String buyCoffee (long water, long milk, long beans, long cost) {
    ...
    repository.getCups() > 0) {
      ...
      return "Making coffee in progress..." + System.lineSeparator() + "Complete!";
    } else {
