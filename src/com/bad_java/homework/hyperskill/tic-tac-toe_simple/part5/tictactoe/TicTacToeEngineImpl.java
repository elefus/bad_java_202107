 ...
 */
public class TicTacToeEngineImpl {
	...
	public TicTacToeEngineImpl(List<List<String>> gameBoard, Terminal terminal) {
		this.gameBoard = gameBoard;
		this.terminal = terminal;
	}

	public TicTacToeEngineImpl(Terminal terminal) {
	...
	public void run() {
		...
		printGameBoard();
		while (gameState.equals(States.NOT_FINISHED)) {
	...
	private void makeMove(int coordinate1, int coordinate2) throws IllegalArgumentException {
		...
		if (coordinate1 < 0 || coordinate1 > gameBoard.size() - 1) {
			throw new IllegalArgumentException("Coordinate should be from 1 to 3!");
